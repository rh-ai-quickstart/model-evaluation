    ...
    return (
        ...
        <div className="p-4 sm:p-6 lg:p-8">
            <div className="mx-auto max-w-5xl">
                ...
                <div className="mb-6 flex items-start gap-2 rounded-lg border border-blue-200 bg-blue-50/60 px-3 py-2 text-xs text-blue-800 dark:border-blue-800 dark:bg-blue-950/30 dark:text-blue-300">
                    <Info className="mt-0.5 h-3.5 w-3.5 shrink-0" />
                    <span>Comparison results are generated by an LLM judge model and are for informational purposes only. They do not constitute financial, legal, or regulatory advice. Verify results with qualified professionals before making production decisions.</span>
                </div>
